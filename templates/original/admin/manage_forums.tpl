...
<table width="100%" class="maintable">
 ...
 <!-- END SWITCH forum_titles -->
 <!-- BEGIN SWITCH forumrow -->
 <tr>
  <td class="cell2">
   <!-- BEGIN subforum --><a href="../view_forum.php?fid={SUBFORUM_ID}">{SUBFORUM_NAME}</a> &raquo; <!-- END subforum --><a href="../view_forum.php?fid={FORUM_ID}">{FORUM_NAME}</a><br />
