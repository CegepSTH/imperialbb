...
function colorpicker_mouseover(color) {
...
<table width="100%" class="maintable">
 ...
 <form method="post" action="" name="edit_rank">
 <tr>
  <td class="cell1" width="50%">{L.Name}</td><td class="cell2"><input type="text" name="name" value="{NAME}" /></td>
 </tr>
 <tr>
 ...
 <tr>
  <td class="cell1">{L.Rank_Image}<br /><span style="font-size: 10px;">{L.Rank_Image_Explain}</td><td class="cell2"><input type="text" name="image" value="{IMAGE}" /></td>
 </tr>
 <tr>
 ...
 <tr>
  <td class="cell1">{L.Special_Rank}</td><td class="cell2"><input type="checkbox" name="special_rank" value="1" onclick="special_rank_onclick(this.checked);" {SPECIAL_RANK} /></td>
 </tr>
 <tr>
