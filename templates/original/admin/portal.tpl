...
<tr>
	...
	<td style="text-align:right;">
		<form style="display:inline;" action="portal.php?func=delete" method="post">
			{CSRF_TOKEN}
...
<div class="block-form-admin">
	<form action="portal.php?func=save" method="post">
		...
		<label style="width: 70%;"><textarea name="news_content" id="news_content" required></textarea></label>
