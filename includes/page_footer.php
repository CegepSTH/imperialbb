...
$phptime = $generation_time;// round(($generation_time - $db->querytime), 3);
// Setup the SQL and PHP percentage stuff
$percentphp = number_format((($phptime/$generation_time)*100), 2).'%';
$percentsql = 0; //number_format((($db->querytime/$generation_time)*100), 2).'%';
...
$theme->replace_tags("page_footer", array(
	...
	"QUERY_COUNT" => sprintf($lang['Query_Count'], 0),
