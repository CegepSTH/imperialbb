...
define("PLOGIN_DUR_DAY", 1);
define("PLOGIN_DUR_WEEK", 2);
define("PLOGIN_DUR_MONTH", 3);
define("PLOGIN_DUR_HALF_YEAR", 4);
define("PLOGIN_DUR_YEAR", 5);
define("PLOGIN_DUR_FOREVER", 6); // Technically 5 years.
...
define("ERR_CODE_NEWS_UPDATE_FAILED", 12400);
define("ERR_CODE_NEWS_UPDATE_SUCCESS", 12401);
define("ERR_CODE_INVALID_NEWS_ID", 12402);
define("ERR_CODE_NEWS_DELETE_FAILED", 12403);
define("ERR_CODE_NEWS_DELETE_SUCCESS", 12404);

define("ERR_CODE_RANK_CREATE_FAIL", 12444);
define("ERR_CODE_RANKS_UPDATE_FAILED", 12445);
define("ERR_CODE_ACC_DELETE_NO_REASON_PROVIDED", 12446);
define("ERR_CODE_DELETION_PM_SENT", 12447);
define("ERR_CODE_COULDNT_DELETE_ACCOUNT", 12448);
?>
